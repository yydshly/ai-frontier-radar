...
# ── Catalog definition ───────────────────────────────────────────────────────
# The topic taxonomy (categories + keywords) is the single source of truth in
# app/application/radar/relevance.py (C1 Phase A/B). _CategoryDef / _CATEGORIES
# are re-exported here under their original names so the rest of this module is
# unchanged.
from app.application.radar.relevance import (
    CategoryDef as _CategoryDef,
    RELEVANCE_CATEGORIES as _CATEGORIES,
)
