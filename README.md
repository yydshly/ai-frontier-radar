...
- 快照保存：`runtime/content_snapshots/source_item_<id>.json`，不修改 DB schema
...
详见：
- [docs/V1_BETA_9_HTML_CONTENT_FETCH_PLAN.md](docs/V1_BETA_9_HTML_CONTENT_FETCH_PLAN.md) — 正文获取设计
